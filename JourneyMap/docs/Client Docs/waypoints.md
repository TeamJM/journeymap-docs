...
![Waypoint](/img/waypoint.png){ align=left }
...
![Waypoint-Manager](/img/waypoint-manager.png){ align=left }
...
![Waypoint-Chat](/img/waypoint-chat.png){ align=left }

## **Editing Waypoints**

When creating or editing a waypoint, the following screen is shown:

![Waypoint-Edit](/img/waypoint-edit.png){ align=left }
